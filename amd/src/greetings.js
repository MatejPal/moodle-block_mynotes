 ...
 *
 * @module     block_mynotes/greetings
 * @copyright  2024 YOUR NAME <your@email.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

import Selectors from 'block_mynotes/local/greetings/selectors';
import * as Repository from 'block_mynotes/local/greetings/repository';
    ...
    document.addEventListener('click', e =>  {
        if (e.target.closest(Selectors.actions.showGreetingButton)) {
            ...
            if (greetingBlock) {
                ...
                window.console.log("Input Field:", nameField);
                window.console.log("Input Value:", nameField.value);
 ...
 * @returns {Promise}
 */
const userGreeting = (name) => Str.getString('greetinguser', 'block_mynotes', name);
